      ...
      <table class="TblWhite" width="100%">
        <tbody>
          ...
          <tr>
            ...
            <td><asp:Button ID="btnMoveDlvryDate" runat="server" PostBackUrl="~/Tools/MoveDeliveryDate.aspx" Text="Move Delivery Date" /> </td>          </tr>
        </tbody>
      </table>
      <br />
          ...
          <tr valign="top">
            ...
            <td>
              <asp:GridView ID="gvCustomerTypes" runat="server" AllowSorting="True" CssClass="TblZebra"
                AutoGenerateColumns="False" DataSourceID="odsCustomerTypes">
                <Columns>
