...
<asp:Content ID="cntLookupBdy" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:Label ID="lblStatus" runat="server" />
    <ajaxToolkit:TabContainer ID="tabcLookup" runat="server" ActiveTabIndex="2" >
        ...
        <asp:UpdatePanel ID="upnlItems" runat="server" UpdateMode="Conditional">
          <ContentTemplate>
             <asp:GridView ID="gvItems" runat="server" DataSourceID="sdsItems" 
               ...
               style="font-family: Calibri, Arial; font-size: smaller">
             ...
             <asp:SqlDataSource ID="sdsItems" runat="server" 
               ...
               InsertCommand="INSERT INTO [ItemTypeTbl] ([ItemDesc], [SKU] [ItemEnabled], [ItemsCharacteritics], [ItemDetail], [ServiceTypeId], [ReplacementID], [ItemShortName], [SortOrder]) VALUES (?, ?, ?, ?, ?, ?, ?, ?)" 
               OldValuesParameterFormatString="original_{0}" 
               ProviderName="<%$ ConnectionStrings:Tracker08ConnectionString.ProviderName %>" 
               SelectCommand="SELECT ItemTypeID, ItemDesc, SKU, ItemEnabled, ItemsCharacteritics, ItemDetail, ServiceTypeId, iif(IsNull(ReplacementID), 0, ReplacementID) AS Replacement, ItemShortName, SortOrder FROM ItemTypeTbl ORDER BY SortOrder, ItemDesc" 
               UpdateCommand="UPDATE ItemTypeTbl SET ItemDesc = ?, SKU=?, ItemEnabled = ?, ItemsCharacteritics = ?, ItemDetail = ?, ServiceTypeId = ?, ReplacementID = ?, ItemShortName = ?, SortOrder = ? WHERE (ItemTypeID = ?)">
               <DeleteParameters>
        ...
        <asp:GridView id="gvEquipment" runat="server" AllowPaging="True" EmptyDataText="No equipment found"  
          ...
          <Columns>
            <asp:TemplateField ShowHeader="False">
              ...
              <FooterTemplate>
                <asp:Button ID="btnAdd" runat="server" CausesValidation="False" CommandName="Insert" Text="Add" />
              </FooterTemplate>
              <ItemTemplate>
    ...
    <ajaxToolkit:TabPanel ID="tabpnlCities" runat="server" HeaderText="Cities">
      <ContentTemplate>
        ...
        <asp:ObjectDataSource ID="odsCities" runat="server" TypeName="TrackerDotNet.control.CityTblDAL"
  ...
  <asp:ObjectDataSource ID="odsEquipTypes" runat="server" TypeName="TrackerDotNet.control.EquipTypeTbl" 
      ...
      OldValuesParameterFormatString="original_{0}" UpdateMethod="UpdateEquipItem" InsertMethod="InsertEquipItem"
      OnInserting="odsEquipTypes_OnInserting">
      <SelectParameters>
        <asp:Parameter DefaultValue="EquipTypeName" Name="SortBy" Type="String" />
      </SelectParameters>
      <UpdateParameters>
        <asp:Parameter Name="objEquipType" Type="Object" />
      </UpdateParameters>
      <InsertParameters>
        <asp:Parameter Name="objEquipType" Type="Object" />
      </InsertParameters>
