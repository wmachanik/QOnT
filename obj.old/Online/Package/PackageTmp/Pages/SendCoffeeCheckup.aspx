...
<asp:Content ID="cntSendCoffeeCheckupBdy" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <ajaxToolkit:ToolkitScriptManager ID="smCustomerCheckup" runat="server" />
  <asp:UpdateProgress ID="uprgSendEmail" runat="server" AssociatedUpdatePanelID="upnlSendEmail" >
    <ProgressTemplate>
      <img src="../images/animi/BlueArrowsUpdate.gif" alt="loading..." width="16" height="16" />sending....
    </ProgressTemplate>
  </asp:UpdateProgress>
  ...
  <div class="simpleLightBrownForm" style="padding: 10px">
    <asp:UpdatePanel ID="upnlSendEmail" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional" >
      <ContentTemplate>
        ...
        <br /><br />
        <ajaxToolkit:TabContainer ID="tabEmailBody" runat="server">
          <ajaxToolkit:TabPanel ID="tpnlEmailIntro" TabIndex="0" HeaderText="Checkup Intro" runat="server">
            <ContentTemplate>
              <asp:TextBox ID="tbxEmailIntro" runat="server" TextMode="MultiLine" Width="99%" Rows="10" 
              Text="Welcome to Quaffee's coffee checkup or reminder" />
          ...
          <ajaxToolkit:TabPanel ID="tpnlEmailBody" TabIndex="1" HeaderText="Checkup Body" runat="server">
            <ContentTemplate>
              <asp:TextBox ID="tbxEmailBody" runat="server" TextMode="MultiLine" Width="99%" Rows="10" 
              Text="" />
            ...
            <ajaxToolkit:TabPanel ID="tpnlEmailFooter" TabIndex="2" HeaderText="Checkup Footer" runat="server">
              <ContentTemplate>
                <asp:TextBox ID="tbxEmailFooter" runat="server" TextMode="MultiLine" Width="99%" Rows="10" 
                Text="" />
