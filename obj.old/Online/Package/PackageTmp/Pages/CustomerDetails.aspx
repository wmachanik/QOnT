...
<asp:Content ID="cntCustomerDetailsBdy" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <ajaxToolkit:ToolkitScriptManager ID="smCustomerDetails" runat="server">
    ...
    <ContentTemplate>
      <table class="TblMudZebra" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          ...
          <td>
            LastReminderSent: <asp:Label ID="LastReminderLabel" runat="server" Text='<%# Eval("LastDateSentReminder") %>' />
            </td>
        </tr>
        <tr>
...
<!-- ModalPopupExtender -->
  ...
  <br />
  <ajaxToolkit:TabContainer ID="tabcCustomer" runat="server" ActiveTabIndex="0" >
              ...
              <div class="simpleLightGreenForm">
                <asp:GridView ID="gvItems" runat="server" AllowSorting="True" CssClass="TblWhite"
                  ...
                  <Columns>
                    ...
                    <asp:TemplateField HeaderText="Item" SortExpression="ItemProvidedID">
                      <EditItemTemplate>
                      ...
                      <ItemTemplate>
                        <asp:DropDownList ID="ddlItems" runat="server" DataSourceID="odsItems" 
                          DataTextField="ItemDesc" DataValueField="ItemTypeID" AppendDataBoundItems="true"
                          SelectedValue='<%# Bind("ItemProvidedID") %>' Enabled="false">
                          <asp:ListItem Value="0" Text="n/a" />
                        </asp:DropDownList>
                      </ItemTemplate>
                    </asp:TemplateField>
